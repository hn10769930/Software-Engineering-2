...
public class SampleJDBC {
    ...
    public static void addPatientEvent(Connection conn, Scanner scanner) throws SQLException {
     ...
     // Validate Procedure ID (Checking 'Patient ID' column in patients table)
        ...
        System.out.print("Admitted (MM/DD/YYYY): ");
        String admit = scanner.nextLine();
        
        System.out.print("Discharged (MM/DD/YYYY): ");
        ...
        try (PreparedStatement pstmt = conn.prepareStatement(insertSql)) {
            ...
            pstmt.setString(9, Integer.toString(procedureId));
    ...
    public static void addNewProcedure(Connection conn, Scanner scanner) throws SQLException {
        ...
        while (!unique) {
            ...
            try (PreparedStatement checkStmt = conn.prepareStatement(checkProcedureSql)) {
                ...
                ResultSet rs = checkStmt.executeQuery();
                if (rs.next()) {
                    System.out.println("Procedure ID already exists. Try again.");
                } else {
                    unique = true;
                }
            }
    ...
    public static void addNewPatient(Connection conn, Scanner scanner) throws SQLException {
        ...
        while (!validID) {
            ...
            try (PreparedStatement checkStmt = conn.prepareStatement(checkPatientSql)) {
                ...
                ResultSet rs = checkStmt.executeQuery();
                if (rs.next()) {
                    System.out.println("Error: Patient ID already exists. Try a different one.");
                } else {
                    validID = true;
                    System.out.println("Patient ID available.");
                }
            }
        }
        ...
        System.out.print("Emergency Contact (Relation to Patient): ");
        ...
        try (PreparedStatement pstmt = conn.prepareStatement(sql)) {
            ...
            pstmt.setString(6, Integer.toString(h));
